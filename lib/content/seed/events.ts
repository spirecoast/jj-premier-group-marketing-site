...
const SEED: SeedEvent[] = [
  ...
  {
    _id: "event-tampa-theatre-classic",
    title: "Tampa Theatre, classic film Sunday",
    slug: "tampa-theatre-classic-film-sunday",
    ...
    image: img("library/culture-theater-lobby-chandelier", "A movie palace lobby"),
    source: "Tampa Theatre",
    sourceUrl: "https://tampatheatre.org",
  },
  {
    _id: "event-straz-broadway",
    title: "Straz Center, Broadway series opening",
    slug: "straz-center-broadway-opening",
    ...
    source: "Straz Center for the Performing Arts",
    sourceUrl: "https://www.strazcenter.org",
  },
  {
