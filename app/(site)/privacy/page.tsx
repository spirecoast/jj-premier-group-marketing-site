  ...
  return (
    <section className="container-site flex flex-col gap-10 py-section">
      ...
      <div className="prose-jj">
        ...
        <p>
          <strong>What you give us.</strong> When you send a form on this site we collect what you type: your name, email address, phone number, the address of a home you want valued, a listing you asked about, when you are thinking of moving, and your message. When you subscribe to the quarterly letter or the calendar, we collect your email address.
        </p>
        <p>
        ...
        <h2>How we use it</h2>
        <p>
          To answer the enquiry you sent, to show you homes and prepare valuations you asked for, to send you the quarterly letter or the weekly calendar if you subscribed, to keep our records of the work we do for you as Florida law requires, and to improve this website. We do not sell personal information, and we do not use it for anything unrelated to real estate.
        </p>
