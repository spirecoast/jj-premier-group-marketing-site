  ...
  return (
    <section className="container-site flex flex-col gap-8 py-section">
      <div className="flex max-w-[720px] flex-col gap-4">
        ...
        <h1 className="t-display text-navy">We would wait, and try that again.</h1>
        <p className="t-body max-w-measure text-body">
          The page did not load the way it should. It is on our side, not yours. Try again, or call us; we are usually in a house but we pick up.
        </p>
